...
!  integer(i4b), parameter :: ML     = 600
!  integer(i4b), parameter :: MDIM   = 40000
!  integer(i4b), parameter :: MMODES = 8000
...
!  complex(dpc), dimension(MDIM,MDIM) :: aa
!  complex(spc), dimension(MDIM,MDIM) :: A
...
!  complex(spc), dimension(MDIM*MDIM) :: hh
  complex(spc) :: w0,w1,w2,dsw1,dsw2,wsum
...
!   do i = 1,nelem
!      do j = 1,nelem
!         write(35,'(2e24.10)') -real(a2(i,j)),-imag(a2(i,j))
!      end do
!   enddo
!   close(35)

 
!   open(35,file='matrixWd.dat',form='formatted')
!   write(35,*) nelem
!   do i = 1,nelem
!      do j = 1,nelem
!         write(35,'(2e24.10)') real(a1(i,j)),imag(a1(i,j))
!      end do
!   enddo
!   close(35)


!   open(35,file='matrixHd.dat',form='formatted')
!   write(35,*) nelem
!   do i = 1,nelem
!      do j = 1,nelem
!         write(35,'(2e24.10)') real(a0(i,j)),imag(a0(i,j))
!      end do
!   enddo
!   close(35)
